...
<body>
	...
	<div id="checkbox_group">
		...
		<div id="checkbox_content">
  			...
  			<div id="main_content1">5pen Run 필수 동의 항목</div><br>
  			...
  			<div id="main_content2">5pen Run 선택 동의 항목</div><br>	
	...
	<script type="text/javascript">
        ...
        function Submit() {
            ...
            if (!allChecked) {
                ...
                location.href = "createUserAccountForm";
            }
        }
    </script>
</body>
